...
The orphan count remains high across both passes. A large proportion of insights are not identified as being represented in theme summaries, even after reinsertion. Given that the resulting output qualitatively presents as a coherent and detailed literature review, this pattern suggests several plausible explanations rather than indicating a catastrophic failure of theme summarization or reintegration.
...
In this sense, orphan handling does not merely correct errors; it operationalizes a structural property of synthesis itself. By forcing abstraction to confront what it would otherwise discard, the system makes synthesis loss explicit and contestable rather than silent. This introduces a potentially important trade-off between coherence, abstraction, and completeness, the desirability of which remains an empirical question.
